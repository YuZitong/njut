...
figure(5)
imshow(I,[0,255],'border','tight','InitialMagnification','fit');
saveas(figure(5),'Iout4','eps');
%title('I');
figure(6)
imshow(I_grad_x,[],'border','tight','InitialMagnification','fit');
saveas(figure(6),'Ioutx4','eps');
%title('I-grad-x');
figure(7)
imshow(I_grad_y,[],'border','tight','InitialMagnification','fit');
saveas(figure(7),'Iouty4','eps');
%title('I-grad-y');
